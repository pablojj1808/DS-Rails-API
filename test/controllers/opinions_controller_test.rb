...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { body: @opinion.body, event_id: @opinion.event_id, starts: @opinion.starts, title: @opinion.title } }
    end
  ...
  test "should update opinion" do
    patch opinion_url(@opinion), params: { opinion: { body: @opinion.body, event_id: @opinion.event_id, starts: @opinion.starts, title: @opinion.title } }
